...
public class NormalCFL {
	...
	public Set<String> getInputs() {
		...
		for(String input : this.unaryProductionsByInput.keySet()) {
			inputs.add(input);
		}
		for(String input : this.binaryProductionsByFirstInput.keySet()) {
			inputs.add(input);
		}
		for(String input : this.binaryProductionsBySecondInput.keySet()) {
			inputs.add(input);
		}
		return inputs;
	}
